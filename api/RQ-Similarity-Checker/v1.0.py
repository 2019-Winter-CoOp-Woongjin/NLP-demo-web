...
if __name__ == "__main__":
    ...
    BOW_text = getBOW(text, nng_sensitivity=2, nnp_sensitivity=2, vv_sensitivity=2)
    BOW_paragraph = difference(getBOW(paragraphs[paragraph], nng_sensitivity=2, vv_sensitivity=2), BOW_text)
    ...
    print("지문 유사도: " + str(match_count_text / len(BOW_question) * 100) + "%")
    print("문단 유사도: " + str(match_count_paragraph / len(BOW_question) * 100) + "%")
